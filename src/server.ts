...
// list here to resolve all api calls
// resolve all api/outdoor/mountains calls
...
// resolve the non api base url requests
// TODO: seems to be an issue between dev vs start(off dist)
fastify.get('/about', (req, reply) => {
  return reply.html();
});
fastify.get('/mountains', (req, reply) => {
  return reply.html();
});
